...
return array(
    ...
    */
    ...
    "integer"          => ":attribute باید فقط از نوع عددی باشد.",
    ...
    */
    'attributes' => array(
        ...
        'address_state' => 'استان',
        'address_city' => 'شهر',
        'address_post_code' => 'کد پستی',
        'address_address' => 'آدرس',
        'national_code' => 'کد ملی',
        'shipping_state' => 'استان',
        'shipping_city' => 'شهر',
        'hex_code' => 'رنگ',
        'code' => 'کد',
        'pay_with_zarinpal' => 'درگاه پرداخت زرین پال',
        'pay_with_idpay' => 'درگاه پرداخت آیدی پی',
        'zarinpal_merchant_id' => 'مرچنت کد زرین پال',
        'idpay_merchant_id' => 'مرچنت کد آیدی پی',
        'portfolio_category_id' => 'دسته بندی',
        ...
        'weight' => 'وزن',
        'company_id' => 'ایرلاین',
        'air_destination_id' => 'فرودگاه مقصد',
        'dest' => 'فرودگاه مقصد',
